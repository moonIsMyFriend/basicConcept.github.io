...
empirical 경합할 수 있는  
surrogate: 대리  
epoch : a period of time in history or a person's life, typically one marked by notable events or particular characteristics. 주어진 배치를 학습에 몇 번 사용할 것인가를 나타내는 변수.  
log-likelihood  
nature log  
cross-entropy  
chain rule:
